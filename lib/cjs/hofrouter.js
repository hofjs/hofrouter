...
exports.HofRouter = void 0;
const hof_1 = require("@hofjs/hofjs/lib/esm/hof");
class HofRouter {
    static _setup() {
    ...
    static _findNextView(mountElement, route) {
        for (const child of Array.from(mountElement.children))
            if (child instanceof hof_1.HofHtmlElement && child.getAttribute("router-url") == route.url)
                return child;
        return null;
    }
